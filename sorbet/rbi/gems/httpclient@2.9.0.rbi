...
class HTTP::Message
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#1044
  def body; end

  # Sets a new body.  header.body_size is updated with new body.size.
  #
  # source://httpclient//lib/httpclient/http.rb#974
  def body=(body); end
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#1002
  def code; end
  ...
  # Returns 'Content-Type' header value.
  #
  # source://httpclient//lib/httpclient/http.rb#1030
  def contenttype; end

  # Sets 'Content-Type' header value.  Overrides if already exists.
  #
  # source://httpclient//lib/httpclient/http.rb#1031
  ...
  #
  # source://httpclient//lib/httpclient/http.rb#1043
  def header; end
  ...
  # Returns HTTP status code in response.  Integer.
  #
  # source://httpclient//lib/httpclient/http.rb#1003
  def status_code; end
  ...
  class << self
    ...
    #
    # source://httpclient//lib/httpclient/http.rb#791
    ...
    #
    # source://httpclient//lib/httpclient/http.rb#790
    ...
    # source://httpclient//lib/httpclient/http.rb#719
    def new(*_arg0); end
  end
end
...
class HTTP::Message::Headers
  ...
  # Returns 'Content-Type' header value.
  #
  # source://httpclient//lib/httpclient/http.rb#235
  def contenttype; end

  # Sets 'Content-Type' header value.  Overrides if already exists.
  #
  # source://httpclient//lib/httpclient/http.rb#236
  def contenttype=(content_type); end
...
HTTP::Message::Headers::NIL_URI = T.let(T.unsafe(nil), URI::HTTP)
...
class HTTPClient
  ...
  # It immediately returns a HTTPClient::Connection instance as a result.
  #
  # source://httpclient//lib/httpclient.rb#872
  ...
  # It immediately returns a HTTPClient::Connection instance as a result.
  #
  # source://httpclient//lib/httpclient.rb#866
  ...
  # It immediately returns a HTTPClient::Connection instance as a result.
  #
  # source://httpclient//lib/httpclient.rb#878
  ...
  #
  # source://httpclient//lib/httpclient.rb#846
  ...
  #
  # source://httpclient//lib/httpclient.rb#943
  ...
  #
  # source://httpclient//lib/httpclient.rb#949
  ...
  #
  # source://httpclient//lib/httpclient.rb#965
  def reset(uri); end

  # Resets all of internal sessions.  Keep-alive connections are disconnected.
  #
  # source://httpclient//lib/httpclient.rb#971
  def reset_all; end
...
class HTTPClient::BasicAuth < ::HTTPClient::AuthBase
  ...
  # source://httpclient//lib/httpclient/auth.rb#249
  def lock; end
...
class HTTPClient::DigestAuth < ::HTTPClient::AuthBase
  ...
  # source://httpclient//lib/httpclient/auth.rb#332
  def lock; end
...
# source://httpclient//lib/httpclient.rb#1215
...
class HTTPClient::NegotiateAuth < ::HTTPClient::AuthBase
  ...
  # source://httpclient//lib/httpclient/auth.rb#500
  def lock; end
...
class HTTPClient::OAuth < ::HTTPClient::AuthBase
  ...
  # source://httpclient//lib/httpclient/auth.rb#683
  def lock; end
...
class HTTPClient::SSLConfig
  ...
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#149
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#274
  def add_crl(crl); end
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#237
  def add_trust_ca(trust_ca_file_or_hashed_dir); end

  # source://httpclient//lib/httpclient/ssl_config.rb#247
  ...
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#137
  def cert_store; end
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#221
  def cert_store=(cert_store); end

  # Returns the value of attribute cert_store_crl_items.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#146
  def cert_store_crl_items; end

  # source://httpclient//lib/httpclient/ssl_config.rb#76
  def ciphers; end

  # source://httpclient//lib/httpclient/ssl_config.rb#79
  def ciphers=(rhs); end
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#208
  ...
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#344
  def default_verify_callback(is_ok, ctx); end

  # Loads default trust anchors.
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#257
  ...
  # @raise [SSL::SSLError]
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#316
  def post_connection_check(peer_cert, hostname); end

  # Sample callback method:  CAUTION: does not check CRL/ARL.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#364
  ...
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#179
  def set_client_cert_file(cert_file, key_file, pass = T.unsafe(nil)); end

  # interfaces for SSLSocket.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#290
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#283
  def set_crl(crl); end
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#197
  ...
  # Calling this method resets all existing sessions.
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#245
  ...
  # @return [Boolean]
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#285
  def verify?; end
  ...
  # source://httpclient//lib/httpclient/ssl_config.rb#420
  def change_notify; end

  # Use 2048 bit certs trust anchor
  #
  # source://httpclient//lib/httpclient/ssl_config.rb#426
  def load_cacerts(cert_store); end

  class << self
    private

    # source://httpclient//lib/httpclient/ssl_config.rb#73
...
#
# source://httpclient//lib/httpclient/ssl_config.rb#90
...
class HTTPClient::SSPINegotiateAuth < ::HTTPClient::AuthBase
  ...
  # source://httpclient//lib/httpclient/auth.rb#597
  def lock; end
...
class HTTPClient::Site
  ...
  # Host String.
  #
  # source://httpclient//lib/httpclient/session.rb#40
  def hostname; end
...
module HTTPClient::Util
  ...
  class << self
    # Finds a value of a Hash.
    #
    # source://httpclient//lib/httpclient/util.rb#187
    def hash_find_value(hash, &block); end
    ...
    # require returns false if the feature is already loaded.
    #
    # source://httpclient//lib/httpclient/util.rb#199
    def try_require(feature); end

    # Returns parent directory URI of the given URI.
    #
    # source://httpclient//lib/httpclient/util.rb#180
    def uri_dirname(uri); end
    ...
    # * target URI's path starts with base URI's path.
    #
    # source://httpclient//lib/httpclient/util.rb#172
    def uri_part_of(uri, part); end

    # Gets an URI instance.
    #
    # source://httpclient//lib/httpclient/util.rb#159
    def urify(uri); end
  end
end

# source://httpclient//lib/httpclient/util.rb#92
HTTPClient::Util::AddressableEnabled = T.let(T.unsafe(nil), FalseClass)
...
class WebAgent::CookieManager
  ...
  # source://httpclient//lib/httpclient/webagent-cookie.rb#313
